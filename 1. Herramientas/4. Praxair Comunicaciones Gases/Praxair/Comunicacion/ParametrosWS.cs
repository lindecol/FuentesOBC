...
namespace PraxairComunicaciones
{
    ...
    {
        public ParametrosWS(int pPrograma, int pProceso, string pIdTerminal, string pIdSistema, bool pComprimir, bool pUpdateCurrentRows, bool pUsarGPRS, string pDescripcionProceso, string sConexionGprs, MovilidadCF.Data.DataSetSerializer.QueryList listQuery, params object[] pParametros)
        {
