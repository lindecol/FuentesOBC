...
namespace PraxairComunicaciones
{
    ...
    {
        public static void ConfigurarServicioWeb(string sIp, string sPuertoTCP, string sCarpetaVirtual, string sUsuarioWS, string sContrasenaWS, int iTimeOut, string sIpGPRS, bool usaHTTPS)
        {
            Comunicacion.CargaDatosForm.ConfiguracionServidorWS(sIp,sPuertoTCP,sCarpetaVirtual,sUsuarioWS,sContrasenaWS,iTimeOut, sIpGPRS, usaHTTPS);
            Comunicacion.DescargarDatosForm.ConfiguracionServidorWS(sIp, sPuertoTCP, sCarpetaVirtual, sUsuarioWS, sContrasenaWS, iTimeOut, sIpGPRS, usaHTTPS);
        }
