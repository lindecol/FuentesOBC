...
namespace PraxairComunicaciones
{
    ...
    {
        public static void ConfigurarServicioWeb (string sIp, string sPuertoTCP, string sCarpetaVirtual, string sUsuarioWS, string sContrasenaWS, int iTimeOut, bool usaHTTPS){
            Comunicacion.CargaDatosForm.ConfiguracionServidorWS(sIp, sPuertoTCP, sCarpetaVirtual, sUsuarioWS, sContrasenaWS, iTimeOut, usaHTTPS);
            Comunicacion.DescargarDatosForm.ConfiguracionServidorWS(sIp, sPuertoTCP, sCarpetaVirtual, sUsuarioWS, sContrasenaWS, iTimeOut, usaHTTPS);
        }
