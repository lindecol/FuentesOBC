...
namespace PraxairComunicaciones.WSPraxair {
    ...
    public partial class DataAccess : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public DataAccess() {
            this.Url = "http://localhost/WebServicesOBCLiquidos/DataAccess.asmx";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetNombreGrupo", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string GetNombreGrupo(string idGrupo) {
            object[] results = this.Invoke("GetNombreGrupo", new object[] {
                        idGrupo});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginGetNombreGrupo(string idGrupo, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GetNombreGrupo", new object[] {
                        idGrupo}, callback, asyncState);
        }
        
        /// <remarks/>
        public string EndGetNombreGrupo(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GrabaErrorTerminal", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void GrabaErrorTerminal(string sTerminal, int iCodigoPrograma, string sMensaje, string sStack) {
            this.Invoke("GrabaErrorTerminal", new object[] {
                        sTerminal,
                        iCodigoPrograma,
                        sMensaje,
                        sStack});
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGrabaErrorTerminal(string sTerminal, int iCodigoPrograma, string sMensaje, string sStack, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GrabaErrorTerminal", new object[] {
                        sTerminal,
                        iCodigoPrograma,
                        sMensaje,
                        sStack}, callback, asyncState);
        }
        
        /// <remarks/>
        public void EndGrabaErrorTerminal(System.IAsyncResult asyncResult) {
            this.EndInvoke(asyncResult);
        }
