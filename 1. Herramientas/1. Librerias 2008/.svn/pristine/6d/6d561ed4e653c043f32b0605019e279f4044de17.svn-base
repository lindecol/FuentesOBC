...
namespace MovilidadCF.Net
{
    class ConnectionManager
    {
        ...
        public static bool ConnectToWork()
        {
            return Setup("http://intranet/default.aspx");
        }

        public static bool ConnectToInternet()
        {
            return Setup("http://www.microsoft.com/default.aspx");
        }

        private static bool Setup(Uri url)
        {
        ...
        private static bool Release(Uri url)
        {
            return Release(url.ToString());
        }

        private static bool Release(string urlStr)
        {
