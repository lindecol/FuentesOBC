    ...
    public class Gps
    {
        ...
        private void CreateGpsEventThread()
        {
            ...
            if (gpsEventThread == null && gpsHandle != IntPtr.Zero)
            {
                ...
                gpsEventThread = new Thread(new ThreadStart(WaitForGpsEvents));
                    ...
                    if (obj != waitFailed)
                    {
                        switch (obj)
                        {
                            ...
                            case 1:
                                ...
                                {
                                    Parent.BeginInvoke(deviceStateChanged,this, new DeviceStateChangedEventArgs(GetDeviceState()));
                                }
                                break;
                            case 2:
                                ...
                                {
                                    Parent.BeginInvoke(locationChanged, this, new LocationChangedEventArgs(GetPosition()));
                                }
                                break;
                        }
                    }
