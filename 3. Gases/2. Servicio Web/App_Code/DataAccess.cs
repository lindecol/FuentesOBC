...
public class DataAccess : System.Web.Services.WebService
{
    ...
    public string GetDatosCarga(string sTerminal, int iCodigoProceso, int iCodigoPrograma)
    {
        ...
        //pruebas
        string resultadi = "";
        StreamReader archivo = new StreamReader("D:\\OBC\\BK-C-Proceso14082020113050.txt");
        resultadi = archivo.ReadToEnd();
        archivo.Close();
        byte[] btData2 = DataCompression.Compress(resultadi).ToArray();
