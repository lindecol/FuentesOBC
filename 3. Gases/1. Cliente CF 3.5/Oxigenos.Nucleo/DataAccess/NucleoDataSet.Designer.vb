...
Partial Public Class NucleoDataSet
    ...
    Partial Public Class DireccionesClienteDataTable
        Inherits Global.System.Data.TypedTableBase(Of DireccionesClienteRow)
    ...
    Partial Public Class TalonariosDataTable
        Inherits Global.System.Data.TypedTableBase(Of TalonariosRow)
    ...
    Partial Public Class TiposClienteDataTable
        Inherits Global.System.Data.TypedTableBase(Of TiposClienteRow)
    ...
    Partial Public Class TiposPagoDataTable
        Inherits Global.System.Data.TypedTableBase(Of TiposPagoRow)
...
Namespace NucleoDataSetTableAdapters
    ...
    Partial Public Class ClientesTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     Codigo, CodSucursal, Nombre, Nit, DiaAtencion, TipoPago, DiasCredito, "& _ 
                "PasswordCliente, EstadoVisita, Secuencial, DiaRuta, Telefono, CodTipoCliente, "&Global.Microsoft.VisualBasic.ChrW(10)&" "& _ 
                "                     FrecuenciaMensual, CreditoDisponible, Nuevo, DeudaSoles, De"& _ 
                "udaDolares, PagaAlquiler, PagaDeposito, Pedidos, Direccion, Barrio, Acarreo"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM"& _ 
                "         Clientes"
            ...
            Me._commandCollection(1).CommandText = "SELECT     Acarreo, Barrio, CodSucursal, CodTipoCliente, Codigo, CreditoDisponibl"& _ 
                "e, DeudaDolares, DeudaSoles, DiaAtencion, DiaRuta, DiasCredito, Direccion, "&Global.Microsoft.VisualBasic.ChrW(10)&"    "& _ 
                "                  EstadoVisita, FrecuenciaMensual, Nit, Nombre, Nuevo, PagaAlqui"& _ 
                "ler, PagaDeposito, PasswordCliente, Pedidos, Secuencial, Telefono, TipoPago"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM"& _ 
                "         Clientes"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (Codigo = @CodCliente)"
    ...
    Partial Public Class DireccionesClienteTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT     CodigoCliente, CodigoDireccion, Direccion, Barrio"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Direcci"& _ 
                "onesCliente"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CodigoCliente = @CodCliente)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@CodCliente"
            param.Size = 8
            ...
            Me._commandCollection(2).CommandText = "SELECT     CodigoCliente, CodigoDireccion, Direccion, Barrio"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Direcci"& _ 
                "onesCliente"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CodigoCliente = @CodCliente) AND (CodigoDireccion = @CodD"& _ 
                "ireccion)"
    ...
    Partial Public Class TalonariosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     Consecutivo, Inicio, Fin, NumeroResolucion, FechaFinResolucion, Actual"& _ 
                ", Prefijo, FechaInicioResolucion, CodTipoDocumento, ResolucionDesde, "&Global.Microsoft.VisualBasic.ChrW(10)&"          "& _ 
                "            ResolucionHasta"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Talonarios"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class ParametrosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = ""&Global.Microsoft.VisualBasic.ChrW(10)&"                      SELECT     CodigoEmpresa, CodigoGrupo, CodigoSucursal, Cod"& _ 
                "igoTerminal, DiaSemana, RutaPrincipal, CodigoPuntoVenta, TipoRuta, CodigoChofer,"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(10)&"                      NombreChofer, ClaveChofer, MensajeChofer, CodigoVehiculo,"& _ 
                " CodigoTrasportadora, NombreEmpresaTrasportadora, NitTrasportadora,"&Global.Microsoft.VisualBasic.ChrW(10)&"            "& _ 
                "          DireccionTrasportadora, ProductoCopago, ProductoCuota, CotizacionDolar"& _ 
                ", NitPraxair, KilometrajeInicial, KilometrajeFinal, NombreSucursal,"&Global.Microsoft.VisualBasic.ChrW(10)&"            "& _ 
                "          TelefonoTransportador, NoMovimiento, VistaRutero, ConsecutivoDepositos"& _ 
                ", ConsecutivoAsignaciones, ConsecutivoAlquileres, PedidoActual,"&Global.Microsoft.VisualBasic.ChrW(10)&"                "& _ 
                "      IntervaloNovedades, DescargaRealizada,case when (isnull(FechaDocumentos)=1"& _ 
                ") then '1980-01-01 00:00:00.000' ELSE FechaDocumentos end fechadocumentos"&Global.Microsoft.VisualBasic.ChrW(10)&"      "& _ 
                "                FROM         Parametros"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class PedidosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(2) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT  COUNT(*) AS Cantidad"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM     Pedidos"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE  (Estado  <> '0') "
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class MaestroGuiasTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        NoMovimiento, TipoDocumento, NoFactura, Reimpresion"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM           "& _ 
                " MaestroGuias"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
