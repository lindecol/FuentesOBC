...
Partial Public Class VentaDataSet
    ...
    Partial Public Class DetallePedidoDataTable
        ...
        Public Overloads Function AddDetallePedidoRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {NoPedido, CodProducto, MetodoEntrega, PresionInicial, PresionFinal, NivelInicial, NivelFinal, PesoInicial, PesoFinal, Cantidad, PrecioUnitario, PrecioTotal, PocentajeDescuento, PorcentajeImpuesto, MontoDescuento, MontoImpuesto, Nothing, Kilometraje, Tanque}
        ...
        Public Overloads Function AddDetallePedidoRow( _
                    ...
                    ByVal MontoImpuesto As Decimal,  _
                    ByVal parentTanquesClienteRowByTanquesCliente_DetallePedido As TanquesClienteRow,  _
                    ByVal Kilometraje As String) As DetallePedidoRow
            Dim rowDetallePedidoRow As DetallePedidoRow = CType(Me.NewRow,DetallePedidoRow)
            Dim columnValuesArray() As Object = New Object() {NoPedido, CodProducto, MetodoEntrega, PresionInicial, PresionFinal, NivelInicial, NivelFinal, PesoInicial, PesoFinal, Cantidad, PrecioUnitario, PrecioTotal, PocentajeDescuento, PorcentajeImpuesto, MontoDescuento, MontoImpuesto, Nothing, Kilometraje, Nothing}
            If (Not (parentTanquesClienteRowByTanquesCliente_DetallePedido) Is Nothing) Then
                columnValuesArray(16) = parentTanquesClienteRowByTanquesCliente_DetallePedido(0)
            End If
            rowDetallePedidoRow.ItemArray = columnValuesArray
...
Namespace VentaDataSetTableAdapters
    ...
    Partial Public Class MaestroFacturasTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     TipoFactura, NoFactura, Prefijo, CodSucursal, CodCliente, Fecha, Moned"& _ 
                ...
                "                  CodTipoPago, NoDiasCredito, OrdenCompra, MontoFactura, MontoFl"& _ 
                "ete, Descuento, ImpuestoTotal, CodEntidad, NoPedido, EstadoFactura"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         "& _ 
                "MaestroFacturas"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class TanquesClienteTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     Tanques.NoTanque, Tanques.Descripcion, Tanques.Capacidad, Tanques.IdFa"& _ 
                "bricante, Tanques.IdGrupoRecipiente, Tanques.IdFamilia, "&Global.Microsoft.VisualBasic.ChrW(10)&"                      T"& _ 
                "anques.IdTipo, ClienteTanque.ProductoTanque"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Tanques INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(10)&"    "& _ 
                "                  ClienteTanque ON Tanques.NoTanque = ClienteTanque.NoTanque"&Global.Microsoft.VisualBasic.ChrW(10)&"WHE"& _ 
                "RE     (ClienteTanque.CodigoCliente = @CodCliente) AND (ClienteTanque.ProductoTa"& _ 
                "nque = @CodProducto)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
    ...
    Partial Public Class AforosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     Nivel, Cantidad"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Aforos"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (IdFabricante = @IdFabri"& _ 
                "cante) AND (IdTipo = @IdTipo) AND (IdFamilia = @IdFamilia) AND (IdGrupo = @IdGru"& _ 
                "po)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
    ...
    Partial Public Class DetallePedidoTableAdapter
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal p20 As String,  _
                    ByVal p21 As String) As Integer
            Return Me.Update(p19, p20, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p21, p18, p19, p20, p21)
        End Function
    End Class
End Namespace
