...
#Region "Eventos Panel GeneracionDocumentos"
    ...
    Private DatosFirma As DatosCapturaFirma = Nothing

    Private Sub CapturarFirma()
        'KUKAN 05-15-2019 CAPTURAR FIRMA Y GUARDAR PDF

        While DatosFirma Is Nothing
...
DeNuevo:
    ...
    Private Sub ValidarDocumentosGenerar()
        ...
        If CIntDBNull(Pedidos.dsPedidos.DetallePedido.Compute("Count(NoPedido)", "UnidadesReales > 0"), 0) > 0 Then
            ...
            'KUXAN 14/09/2020 SIEMPRE GENERAR REMISION
...
DeNuevo:
    ...
    ByRef RowTalonarioFactura As DataRow, ByVal Cantidad As Integer, ByRef RowTalonarioRemision As DataRow) As Boolean
        ...
        For i As Integer = 1 To Cantidad
            ...
            Else
                'KUXAN
                'TODO ES REMISION NO TENGO AUTORIZACION NO HAY ALQUILER                
    ...
    Public Sub MostrarDetalleRemision()
        ...
        'KUXAN SIEMPRE MOSTRAR EL DETALLE DE LA REMISION
        If bRemisionValorizada Or True Then
...
#Region "Eventos Panel Resumen Factura"
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        Try
            ...
            End If
        Catch ex As Exception
            UIHandler.ShowAlert("Error guardando datos en la base de datos" + ex.Message)
...
#End Region
    ...
    Public Shared Sub Run(ByVal rowCliente As System.Data.DataRow, ByRef rowPedido As System.Data.DataRow)
        ...
        If form.DatosFirma IsNot Nothing Then
            If form.DatosFirma.PathFirma IsNot Nothing Then
                form.EliminarFirmas(form.DatosFirma.PathFirma)
            End If
                    ...
                    If m_RowFactura.Length > 0 Then
                        For I As Integer = 0 To m_RowFactura.Length - 1
                            ...
                            While ImpresionOk < 0
                                ...
                                FechaVencimiento, ObtenerInformacionSucursal, DigitoCodebar(m_RowTalonarioFactura("CodTipoDocumento").ToString) + cstrDBNULL(m_RowFactura(I)("Prefijo")) + cstrDBNULL(m_RowFactura(I)("NoFactura")), cstrDBNULL(m_RowFactura(I)("NoFactura")), Observaciones, TipoDocumentos.Factura, cstrDBNULL(m_RowTalonarioFactura("Actual")), cstrDBNULL(m_RowTalonarioFactura("Prefijo")))
                                ...
                                If Not dt Is Nothing Then
                                    ...
                                    Next
                                End If
                                ImpresionOk = Nucleo.Imprimir(Documento, Me.DatosFirma)
                ...
                While ImpresionOk < 0
                    ...
                    If m_RowRemision IsNot Nothing Then
                        If m_RowRemision.Length > 0 Then
                            ...
                            m_gestorVenta.NombreDocumento(CInt(m_RowTalonarioFactura("CodTipoDocumento").ToString)), TipoDocumentos.Remision, sTipoPago, Today(), FechaVencimiento, ObtenerInformacionSucursal, DigitoCodebar(m_RowTalonarioFactura("CodTipoDocumento").ToString) & cstrDBNULL(m_RowRemision(0)("Prefijo")) & cstrDBNULL(m_RowRemision(0)("NoFactura")), cstrDBNULL(m_RowRemision(0)("NoFactura")), "", TipoDocumentos.Remision, cstrDBNULL(m_RowTalonarioFactura("Actual")), cstrDBNULL(m_RowTalonarioFactura("Prefijo")))
            ...
            If GeneraAsignacion Then
                ...
                While ImpresionOk < 0
                    ...
                    If RowAsignacion.Length > 0 Then
                        ...
                        m_gestorVenta.NombreDocumento(CInt(m_RowTalonarioFactura("CodTipoDocumento").ToString)), "ASIGNACION", "", Today(), Today(), ObtenerInformacionSucursal, DigitoCodebar(m_RowTalonarioFactura("CodTipoDocumento").ToString) & cstrDBNULL(RowAsignacion(0)("Prefijo")) & cstrDBNULL(RowAsignacion(0)("NoGuia")), cstrDBNULL(RowAsignacion(0)("NoGuia")), "", "ASIGNACION", cstrDBNULL(m_RowTalonarioFactura("Actual")), cstrDBNULL(m_RowTalonarioFactura("Prefijo")))
                    End If
            ...
            If GeneraRecoleccion Then
                ...
                While ImpresionOk < 0
                    ...
                    If RowAsignacion.Length > 0 Then
                        Documento.SetInfoDocumento(cstrDBNULL(RowAsignacion(0)("Prefijo")) & "-" & _
                        cstrDBNULL(RowAsignacion(0)("NoGuia")), cstrDBNULL(m_RowPedido("NoPedido")), _
                        m_gestorVenta.NombreDocumento(CInt(m_RowTalonarioFactura("CodTipoDocumento").ToString)), "RECOLECCION", "", Today(), Today(), ObtenerInformacionSucursal, DigitoCodebar(m_RowTalonarioFactura("CodTipoDocumento").ToString) & cstrDBNULL(RowAsignacion(0)("Prefijo")) & cstrDBNULL(RowAsignacion(0)("NoGuia")), cstrDBNULL(RowAsignacion(0)("NoGuia")), "", "RECOLECCION", cstrDBNULL(m_RowTalonarioFactura("Actual")), cstrDBNULL(m_RowTalonarioFactura("Prefijo")))
                    End If
            ...
            If dsPacientes.DepositosGarantia.Rows.Count > 0 Then
                ...
                For i = 0 To Cant - 1
                    ...
                    While ImpresionOk < 0
                        ...
                        cstrDBNULL(m_RowPedido("NoPedido")), "DEPOSITOS", "DEPOSITOS", "Contado", Today(), Today(), ObtenerInformacionSucursal, DigitoCodebar(m_RowTalonarioFactura("CodTipoDocumento").ToString) & Prefijo & NoDoc, NoDoc, "", "DEPOSITOS", cstrDBNULL(m_RowTalonarioFactura("Actual")), cstrDBNULL(m_RowTalonarioFactura("Prefijo")))
                        ...
                        If m_RowFactura.Length > 0 Then
                            For I As Integer = 0 To m_RowFactura.Length - 1
                                ...
                                While ImpresionOk < 0
                                    ...
                                    cstrDBNULL(m_RowFactura(I)("NoFactura")), cstrDBNULL(m_RowPedido("NoPedido")), _
                                    m_gestorVenta.NombreDocumento(CInt(m_RowTalonarioFactura("CodTipoDocumento").ToString)), TipoDocumentos.Factura, sTipoPago, Today(), _
                                    FechaVencimiento, ObtenerInformacionSucursal, DigitoCodebar(m_RowTalonarioFactura("CodTipoDocumento").ToString) + cstrDBNULL(m_RowFactura(I)("Prefijo")) + cstrDBNULL(m_RowFactura(I)("NoFactura")), cstrDBNULL(m_RowFactura(I)("NoFactura")), "", TipoDocumentos.Factura, cstrDBNULL(m_RowTalonarioFactura("Actual")), cstrDBNULL(m_RowTalonarioFactura("Prefijo")))
                                    '"FACTURA DE VENTA", TipoDocumentos.Factura, sTipoPago, Today(), _
                                    'I N F O R M A C I O N  T O T A L E S  D E  L A  F A C T U R A
                                    SubTotal = CDec(m_RowFactura(I)("MontoFactura")) - CDec(m_RowFactura(I)("ImpuestoTotal"))
                                    Documento.SetInfoTotales(SubTotal, Math.Round(CDec(m_RowFactura(I)("ImpuestoTotal"))))
