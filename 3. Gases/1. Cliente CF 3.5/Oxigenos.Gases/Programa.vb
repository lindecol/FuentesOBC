...
Public Class Programa
    ...
    Public Overrides Function ValidarInicioRutero(ByRef sMensaje As String) As Boolean
        If Today() = Nucleo.FechaCarga Or True Then
    ...
    Public Overrides Sub CargarDatosIniciales()
        ...
        'KUXAN: 14/01/2020
        Dim original As String = Path.Combine(Application2.StartupPath, "Facturagases.LBL")
        MovilidadCF.Logging.Logger.Write(original)
        If File.Exists(original) Then
            Try
                File.Copy(original, "\Application\Facturagases.LBL", True)
        ...
        original = Path.Combine(Application2.StartupPath, "ReporteControEnvases.LBL")
        MovilidadCF.Logging.Logger.Write(original)
        If File.Exists(original) Then
            Try
                File.Copy(original, "\Application\ReporteControEnvases.LBL", True)
            Catch ex As Exception
                MovilidadCF.Logging.Logger.Write(ex)
            End Try
        ...
        original = Path.Combine(Application2.StartupPath, "ReporteDocumentos.LBL")
        MovilidadCF.Logging.Logger.Write(original)
        If File.Exists(original) Then
            Try
                File.Copy(original, "\Application\ReporteDocumentos.LBL", True)
            Catch ex As Exception
                MovilidadCF.Logging.Logger.Write(ex)
            End Try
        ...
        original = Path.Combine(Application2.StartupPath, "DatosRecoleccion.txt")
        MovilidadCF.Logging.Logger.Write(original)
        If File.Exists(original) Then
            Try
                File.Copy(original, "\Application\DatosRecoleccion.txt", True)
            Catch ex As Exception
                MovilidadCF.Logging.Logger.Write(ex)
            End Try
