...
Public Class VentaPorCaudalimetroForm
    ...
    ByVal rowTanque As VentaDataSet.TanquesClienteRow)
        UIHandler.StartWait()
        Dim frm As New VentaPorCaudalimetroForm
    ...
    Private Sub LoadData()
        ...
        m_rowDetalle.CodProducto = m_rowTanque.ProductoTanque
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click, menuGuardar.Click
        ...
        Try
            ...
            If m_rowDetalle.PesoFinal < 0 Then
                Throw New Exception("Medida entrega  debe ser mayor a cero")
            End If
            ...
            If Productos.ProductoActual.UnidadMedidaVenta = UnidadesMedida.MetrosCubicos Then
                ...
                m_rowDetalle.Cantidad = CDec(m_rowDetalle.Cantidad)
            End If
            ...
            m_rowDetalle.MontoDescuento = CDec((Precio.PorcentajeDescuento * m_rowDetalle.Cantidad) / 100)
    ...
    Private Sub txtPresionInicial_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPresionInicial.TextChanged
