Public Class GestorHojasRutas
    ...
    Public Sub LoadTanqueros(ByVal CodProducto As String)
        ...
        dtaTanqueros.FillByProducto(dsHojasRuta.Tanqueros, CodProducto, CodProducto)
    End Sub
    Public Sub loadReporteHojaRuta()
        dtaReporteHojaRuta.Connection = Me.Connection
        dtaReporteHojaRuta.Fill(dsHojasRuta.ReporteHojaRuta)
    End Sub
    Public Sub LoadDetalleHojaRuta()
        dtaReporteDetalleHojaRuta.Connection = Me.Connection
        dtaReporteDetalleHojaRuta.Fill(dsHojasRuta.ReporteDetalleHojaRuta)
    End Sub

    Public Function NumerohojarutaActual() As Double
        dtaReporteDetalleHojaRuta.Connection = Me.Connection

        Return Convert.ToDouble(dtaHojasRuta.IdHojaRutaActual)
    End Function
End Class
