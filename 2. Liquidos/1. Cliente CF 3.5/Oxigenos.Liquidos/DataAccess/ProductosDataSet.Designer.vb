...
Partial Public Class ProductosDataSet
    ...
    Partial Public Class ProductosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddProductosRow(ByVal Codigo As String, ByVal Descripcion As String, ByVal CoeficienteProducto As Single, ByVal Precio As Single, ByVal Iva As Single, ByVal UnidadMedidaVenta As String, ByVal Principal As Byte, ByVal Flete As String) As ProductosRow
            Dim rowProductosRow As ProductosRow = CType(Me.NewRow,ProductosRow)
            Dim columnValuesArray() As Object = New Object() {Codigo, Descripcion, CoeficienteProducto, Precio, Iva, UnidadMedidaVenta, Principal, Flete}
    ...
    Partial Public Class ProductosRow
        ...
        Public Property Principal() As Byte
            Get
                Try 
                    Return CType(Me(Me.tableProductos.PrincipalColumn),Byte)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Principal' in table 'Productos' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableProductos.PrincipalColumn) = value
            End Set
        End Property
        ...
        Public Property Flete() As String
            Get
                Try 
                    Return CType(Me(Me.tableProductos.FleteColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Flete' in table 'Productos' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Function IsPrincipalNull() As Boolean
            Return Me.IsNull(Me.tableProductos.PrincipalColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetPrincipalNull()
            Me(Me.tableProductos.PrincipalColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsFleteNull() As Boolean
            Return Me.IsNull(Me.tableProductos.FleteColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetFleteNull()
            Me(Me.tableProductos.FleteColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace ProductosDataSetTableAdapters
    ...
    Partial Public Class ProductosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Productos] ([Codigo], [Descripcion], [CoeficienteProducto], [Precio]"& _ 
                ", [Iva], [UnidadMedidaVenta], [Principal], [Flete]) VALUES (@p1, @p2, @p3, @p4, "& _ 
                "@p5, @p6, @p7, @p8)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Productos] SET [Codigo] = @p1, [Descripcion] = @p2, [CoeficienteProducto]"& _ 
                " = @p3, [Precio] = @p4, [Iva] = @p5, [UnidadMedidaVenta] = @p6, [Principal] = @p"& _ 
                "7, [Flete] = @p8 WHERE (([Codigo] = @p9))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [Codigo], [Descripcion], [CoeficienteProducto], [Precio], [Iva], [UnidadMe"& _ 
                "didaVenta], [Principal] ,   [Flete] FROM [Productos]"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Codigo, CoeficienteProducto, Descripcion, Flete, Iva, Precio, Principal, U"& _ 
                "nidadMedidaVenta, Flete FROM Productos WHERE (Codigo = @CodProducto)"
        ...
        Public Overloads Overridable Function Insert(ByVal p1 As String, ByVal p2 As String, ByVal p3 As Global.System.Nullable(Of Single), ByVal p4 As Global.System.Nullable(Of Single), ByVal p5 As Global.System.Nullable(Of Single), ByVal p6 As String, ByVal p7 As Global.System.Nullable(Of Byte), ByVal p8 As String) As Integer
            If (p1 Is Nothing) Then
                Throw New Global.System.ArgumentNullException("p1")
            Else
        ...
        Public Overloads Overridable Function Update(ByVal p1 As String, ByVal p2 As String, ByVal p3 As Global.System.Nullable(Of Single), ByVal p4 As Global.System.Nullable(Of Single), ByVal p5 As Global.System.Nullable(Of Single), ByVal p6 As String, ByVal p7 As Global.System.Nullable(Of Byte), ByVal p8 As String, ByVal p9 As String) As Integer
            If (p1 Is Nothing) Then
                Throw New Global.System.ArgumentNullException("p1")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal p2 As String, ByVal p3 As Global.System.Nullable(Of Single), ByVal p4 As Global.System.Nullable(Of Single), ByVal p5 As Global.System.Nullable(Of Single), ByVal p6 As String, ByVal p7 As Global.System.Nullable(Of Byte), ByVal p8 As String, ByVal p9 As String) As Integer
    ...
    Partial Public Class PreciosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT AplicaIva, CodCliente, CodProducto, CodSucursal, CodTipoMoneda, Estado, Po"& _ 
                "rcentajeDescuento, PorcentajeImpuesto, PrecioNeto, TieneContrato FROM Precios WH"& _ 
                "ERE (CodSucursal = @CodSucursal) AND (CodCliente = @CodCliente) AND (CodProducto"& _ 
                " = @CodProducto)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
