...
Partial Public Class ReportesDataSet
    ...
    Partial Public Class DocumentosGeneradosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddDocumentosGeneradosRow(ByVal Tipo As String, ByVal Documento As String, ByVal CodCliente As String, ByVal Cliente As String, ByVal Valor As Decimal) As DocumentosGeneradosRow
            Dim rowDocumentosGeneradosRow As DocumentosGeneradosRow = CType(Me.NewRow,DocumentosGeneradosRow)
            Dim columnValuesArray() As Object = New Object() {Tipo, Documento, CodCliente, Cliente, Valor}
        ...
        Private Sub InitClass()
            ...
            Me.columnCodCliente.ReadOnly = true
            Me.columnCodCliente.Caption = "Cód. Cliente"
            Me.columnCodCliente.MaxLength = 12
            Me.columnCliente.ReadOnly = true
            Me.columnCliente.Caption = "Nombre Cliente"
    ...
    Partial Public Class DocumentosGeneradosRow
        ...
        Public Property CodCliente() As String
            Get
                Try 
                    Return CType(Me(Me.tableDocumentosGenerados.CodClienteColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'CodCliente' in table 'DocumentosGenerados' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableDocumentosGenerados.CodClienteColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsCodClienteNull() As Boolean
            Return Me.IsNull(Me.tableDocumentosGenerados.CodClienteColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetCodClienteNull()
            Me(Me.tableDocumentosGenerados.CodClienteColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace ReportesDataSetTableAdapters
    ...
    Partial Public Class DocumentosGeneradosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     CASE WHEN MaestroFacturas.TipoFactura = 'B' THEN 'Remisión Automática'"& _ 
                " WHEN MaestroFacturas.TipoFactura = 'F' THEN 'Factura Automática' END"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"         "& _ 
                "              AS Tipo, MaestroFacturas.NoFactura AS Documento, Clientes.Codigo A"& _ 
                "S CodCliente, Clientes.Nombre AS Cliente, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      MaestroFactura"& _ 
                "s.MontoFactura AS Valor"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Clientes RIGHT OUTER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"               "& _ 
                "       MaestroFacturas ON Clientes.Codigo = MaestroFacturas.CodCliente"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY"& _ 
                " Tipo, Documento"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
