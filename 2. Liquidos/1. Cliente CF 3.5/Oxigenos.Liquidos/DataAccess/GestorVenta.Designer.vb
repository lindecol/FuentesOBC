...
Partial Public Class GestorVenta
    ...
    Private Sub InitializeComponent()
        ...
        Me.dtaGuia_Documento = New Oxigenos.Liquidos.VentaDataSetTableAdapters.Guia_DocumentoTableAdapter
        '
        'dsVenta
        '
    ...
    Friend WithEvents dtaGuia_Documento As Oxigenos.Liquidos.VentaDataSetTableAdapters.Guia_DocumentoTableAdapter
