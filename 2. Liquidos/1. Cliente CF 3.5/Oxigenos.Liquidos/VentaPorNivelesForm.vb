...
Public Class VentaPorNivelesForm
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click, menuGuardar.Click
        ...
        Try
            ...
            If rowAforo Is Nothing Then
                Throw New Exception("No esta definido el nivel final en la tabla de aforo")
            End If
    ...
    Private Sub txtPresionFinal_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPresionFinal.TextChanged

    End Sub

    Private Sub DTHoraAtencion_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
