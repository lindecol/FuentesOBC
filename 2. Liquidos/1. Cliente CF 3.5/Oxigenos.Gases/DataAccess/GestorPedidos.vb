...
Public Class GestorPedidos
    ...
    ByVal Cantidad As Short)
        ...
        RowDetalle = dsPedidos.DetallePedido.FindByNoPedidoCodProductoCapacidad(cstrDBNULL(RowPedido("NoPedido")), Row.Codigo, sCapacidad)
        If RowDetalle IsNot Nothing Then
            ...
            sCapacidad, cstrDBNULL(RowCliente("TipoPago")), RowCliente)
        Else
            If Cantidad > 0 Then
                UnidadMedida = Row.UnidadMedida
                PorcentajeIva = Row.Iva
                ...
                ' se actualiza el flete si es necesario
                ActualizarFlete(cstrDBNULL(RowPedido("NoPedido")), sCodFlete, Cantidad, Row.Codigo, sCapacidad, cstrDBNULL(RowCliente("TipoPago")), RowCliente)
            End If
        End If
    End Sub

    Public Sub ActualizarDetallePedidoPaciente(ByVal RowPedido As DataRow, ByVal RowCliente As DataRow, ByVal sCodFlete As String, _
    ...
    ByVal RowAutorizacion() As DataRow, ByVal CantidadContado As Short, ByVal CantidadCredito As Short, ByVal RespetaPrecio As Boolean)
    ...
    ByVal RespetaPrecio As Boolean, ByVal CodProducto As String)
        ...
        ' Se consulta si el detalle del pedido existe
        RowDetalle = dsPedidos.DetallePedido.FindByNoPedidoCodProductoCapacidad(cstrDBNULL(RowPedido("NoPedido")), CodProducto, sCapacidad)
        If RowDetalle IsNot Nothing Then
    ...
    ByVal CodEntidad As String)
        ...
        If sCodFlete <> "" Then
            ...
            RowDetalle = Me.dsPedidos.DetallePedido.FindByNoPedidoCodProductoCapacidad(sNoPedido, sCodFlete, Flete.Capacidad)
            If RowDetalle IsNot Nothing Then
                If RowDetalle("PrecioContado") Is DBNull.Value Then
                    ' Se inicializan los campos
                    RowDetalle.UnidadesVendidasContado = 0
    ...
    ByVal sTipoPago As String, ByVal RowCliente As DataRow)
