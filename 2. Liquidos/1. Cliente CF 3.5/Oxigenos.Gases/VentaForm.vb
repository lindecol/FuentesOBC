            ...
            If FilaSeleccionada IsNot Nothing Then
                ...
                If CShort(FilaSeleccionada("UnidadesReales")) > 0 Then
                    ...
                    ElseIf cstrDBNULL(FilaSeleccionada("TipoProducto")) = TipoProducto.Producto Then
                        ...
                        ' asignacion
                        If cstrDBNULL(FilaSeleccionada("RequiereAsignacion")) = Asignacion.RequiereAsignacion Then
    ...
    Private Sub ModificarFlete()
        ...
        If FilaSeleccionada IsNot Nothing Then
            ...
            If RowProducto IsNot Nothing Then
                ...
                ElseIf MsgBox("Esta seguro de modificar el flete?", MsgBoxStyle.YesNo, "Confirmación") = MsgBoxResult.Yes Then
                    ...
                    RowDetallePedido = dsPedidos.DetallePedido.FindByNoPedidoCodProductoCapacidad(CStr(m_rowPedido("NoPedido")), _
                    sCodProducto, sCapacidad)
                    ...
                    CantidadFlete, sCodProducto, sCapacidad, cstrDBNULL(m_rowCliente("TipoPago")), m_rowCliente)
                End If
            End If
        End If
    End Sub

    Private Sub ModificarFletePaciente()
        Dim CantidadFlete As Short = 0
        Dim sCodProducto As String = ""
        Dim sCapacidad As String = ""
        Dim UnidadMedida As String = ""
    ...
    Private Sub menuServicio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuServicio.Click
        ...
        If Row IsNot Nothing Then
            ...
            Else
                ...
                Pertenencia.Praxair, CType(Row, ProductosDataSet.ProductosRow), CantidadServicio)
            End If
        End If
    End Sub
