...
Public Class LecturaCilindrosVentaForm
    ...
    Private Sub MostrarDatosAjenoVacio()
        ...
        If dsProductos.Productos.Rows.Count > 0 Then
            ...
            Me.lblDescripcionTipoProducto.Text = cstrDBNULL(dsProductos.Productos.Rows(0)("Descripcion"))
            ValidarDatosLeidos()
        Else
        ...
        If bVentaAutomatica Then
            ...
            Else
                If Me.lblSecuencial.Text <> "" Then
                    ...
                    ProductosDataSet.ProductosRow), Cantidad)
                End If
