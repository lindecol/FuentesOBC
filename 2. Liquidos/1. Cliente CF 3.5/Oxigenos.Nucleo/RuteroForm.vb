...
Public Class RuteroForm
    ...
    Private Sub ProcesarNovedades()
        ...
        'CargaDatosForm.Run(ProcesosComunicacion.CargaNovedades, "Carga Novedades", True, True)
        Comunicacion.ejecutarCarga(GestorNucleo.CadenaConexion, "Carga de Novedades", ProcesosComunicacion.CargaNovedades)
