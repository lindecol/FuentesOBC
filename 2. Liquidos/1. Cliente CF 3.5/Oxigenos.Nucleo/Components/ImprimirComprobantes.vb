            ...
            For i As Integer = 1 To CInt(Settings.NumeroEtiquetas)
                ...
                Select Case i
                    ...
                    Case 5
                        ...
                        copia = "CUARTA COPIA"
                End Select
                If MessageBox.Show("¿Desea imprimir la " + copia + " del documento?", "Impresión", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = DialogResult.Yes Then
