...
#Region " Funciones utilizadas para la integración de datos "
    ...
    Public Sub actualizarGuiaDocumento()
        ...
        cmd.Connection = Me.Connection
        cmd.CommandType = CommandType.TableDirect
        cmd.CommandText = "UPDATE Guia_Documento SET  Transmitido_SN = 'S' WHERE (([Num_Guia] = @NumGuia) AND ([Prefijo_Documento] = PrefijoDoc) AND ([Num_Documento] = @NumDoc))"
    End Sub

    Public Function GetSerializedData(ByVal QueryList As ListQuerysDescarga, ByVal Estado As IEstadoCarga, Optional ByVal id_proceso As Integer = 0) As String
        ...
        Try
            ...
            For I = 0 To QueryList.Count - 1
                If Estado.Cancelado Then
                    Exit For
                End If
                If Not id_proceso = 6 Then Estado.IniciarTabla(QueryList(I).TableName.ToUpper)
                cmd.Connection = Me.Connection
